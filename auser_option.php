...
print("<html><head><title>User options</title>");
...
print("<br>");
echo "<p align=center><a href=\"index.php?boxaction=adduser\">|&nbsp;&nbsp;Add User&nbsp;&nbsp;|</a>";

echo "<a href=\"index.php?&boxaction=viewusers\">&nbsp;&nbsp;View User&nbsp;&nbsp;|</a>";
...
<form method=post action="index.php?boxaction=actsearchuser">
